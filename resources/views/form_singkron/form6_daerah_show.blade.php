			...
			<thead>
				<tr>
					...
					<th>
						...
						<div class="modal fade" id="modal-add-{{$dp['id']}}" aria-modal="true" >
							<div class="modal-dialog">
								<form action="{{route('fs.f6.update_program_daerah',['id_link'=>$id_link,'id'=>$program->id,'kode_daerah'=>$daerah] )}}" method="post">
									@csrf
									@method('PUT')
