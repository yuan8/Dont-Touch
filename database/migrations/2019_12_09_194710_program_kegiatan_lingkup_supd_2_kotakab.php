...
class ProgramKegiatanLingkupSupd2Kotakab extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
        Schema::create('program_kegiatan_lingkup_supd_2_kotakab', function(Blueprint $table) {
    ...
    {
        //
        Schema::dropIfExists('program_kegiatan_lingkup_supd_2_kotakab');
